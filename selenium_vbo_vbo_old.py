...
class SeleniumVboVbo(SeleniumVbo):
    ...
    def loadOnePageAllVbo(self):
        for i in range(0,10):
            ...
            if self.find_element(self.driver.find_element_by_xpath, '//*[@class="page next S_txt1 S_line1"]', None, False):
                return
            time.sleep(30)
    ...
    def nextPage(self):
        if self.current_page>self.MAX_PAGE:
            ...
            self.current_page+=1
        try:
            self.click(self.find_element(self.driver.find_element_by_xpath, '//a[@class="page next S_txt1 S_line1"]', None, True))
    ...
    def getVboCommentNum(self,web_element,vbo,is_forward=False):
        xpath='.//div[@class="WB_feed_expand"]//span[@node-type="comment_btn_text"]' if is_forward else './div[@class="WB_feed_handle"]//span[@node-type="comment_btn_text"]'
    ...
    def getVboRetweet(self,web_element,vbo,is_forward=False):
        xpath= './/div[@class="WB_feed_expand"]//span[@node-type="forward_btn_text"]' if is_forward else './div[@class="WB_feed_handle"]//span[@node-type="forward_btn_text"]'
    ...
    def getVboGoodnum(self,web_element,vbo,is_forward=False):
        xpath= './/div[@class="WB_feed_expand"]//span[@node-type="like_status"]/em' if is_forward else './div[@class="WB_feed_handle"]//span[@node-type="like_status"]/em'
